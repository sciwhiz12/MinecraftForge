...
/**
 * <p>Fired when the client is about to send a chat message or command to the server. <br/>
 * This can be used to implement client-only commands as chat messages, or intercepting messages for typos. </p>
 *
